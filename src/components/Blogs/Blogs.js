...
const Blogs = () => {
    return (
        <div>
            <h2 className='md:text-4xl text-3xl px-2 bg-black text-white text-center pt-4'>Gain more knowladge on ReactJs</h2>
            <div className='md:grid md:grid-cols-3 justify-center gap-3 bg-black text-white py-20 md:px-20 px-3'>
                <div className="p-6 rounded-md shadow-md bg-gray-800 dark:text-gray-50 mb-2">
                ...
                <div className="p-6 rounded-md shadow-md bg-gray-800 text-gray-50">
