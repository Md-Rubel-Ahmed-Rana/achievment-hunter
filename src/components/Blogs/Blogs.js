...
const Blogs = () => {
    return (
        <div>
            ...
            <div className='md:flex justify-center gap-3 bg-black text-white md:even:py-20 md:px-20 px-3'>
                <div className="p-6 rounded-md shadow-md bg-gray-900 dark:text-gray-50 mb-2">
                    <h2 className="text-xl font-semibold tracking-wide">What is the purpose of react router?</h2>
                ...
                <div className="p-6 rounded-md shadow-md bg-gray-900 dark:text-gray-50 mb-2">
                    <h2 className="text-xl font-semibold tracking-wide">How does context api work?</h2>
                ...
                <div className="p-6 rounded-md shadow-md bg-gray-900 text-gray-50">
                    <h2 className="text-xl font-semibold tracking-wide">What is useref hook in react</h2>
                    <p className="dark:text-gray-100">The useRef Hook allows you to persist values between renders. It can be used to store a mutable value that does not cause a re-render when updated. It can be used to access a DOM element directly.</p>
                </div>
            </div>
        </div>
    );
